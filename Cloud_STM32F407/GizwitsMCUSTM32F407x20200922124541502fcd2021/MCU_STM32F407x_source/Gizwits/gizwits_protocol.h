...
* @{
*/
#define PRODUCT_KEY "fcd2021533ae4dbf86568609d5e66cc8"
/**@} */
/**@name Product Secret  
* @{
*/
#define PRODUCT_SECRET "9b826c5970864e8fa31aba5c4928b40f"
...
#define lamp_BITOFFSET                     1
#define lamp_LEN                           1
#define Curtain_BYTEOFFSET                    0
#define Curtain_BITOFFSET                     2
#define Curtain_LEN                           1
#define Fan_BYTEOFFSET                    0
#define Fan_BITOFFSET                     3
#define Fan_LEN                           1
#define Alarm_BYTEOFFSET                    0
#define Alarm_BITOFFSET                     4
#define Alarm_LEN                           1
